...
PDF_PATH = path = Path(__file__).parent / "Project" / "Danish_Abbas_CV_SaudiPak_YEP_2026_v3.pdf"  # change to your file
...
def setup_pipeline_and_query(
    ...
    chunk_size: int = 1000,
    chunk_overlap: int = 150,
    embed_model_name: str = "gemini-embedding-2-preview",
    force_rebuild: bool = False,
):
